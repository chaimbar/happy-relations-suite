...
- 2026-06-28 — תוקן באג בעריכת לקוח: הטופס נטען ריק בגלל useState שאותחל פעם אחת; נוסף key לרימאונט. נדחף לגיטהב (7c5c59c).

- 2026-06-28 — עריכת לקוח עדיין נטענה ריקה; הוחלף ל-useEffect שמסנכרן form לפי editing (דפוס זהה לעובדים). נדחף 88382a5.

- 2026-06-28 — עריכת אתרים/שלבים נטענה ריקה — אותו שורש כמו לקוחות; useEffect sync לשני הדיאלוגים. נדחף 8e5145d.

- 2026-06-28 — הוספת שדה phone2 לטבלת clients ולדיאלוג הוספת/עריכת לקוח. כולל קישור וואטסאפ בכרטיס, חיפוש וייצוא CSV.

- 2026-07-12 · שיפורי CRM: תוספות פרויקט, שיבוץ קבוצתי, drag-and-drop יומי, היסטוריה
- 2026-07-12: שופר UX השיבוץ במסך שיבוצים: פתיחה ביומי, פלוס ליד עובד ללא שיבוץ, וכפתור + שיבוץ ביום ריק.
- 2026-07-12: הרחבת טאב היסטוריית שיבוצים - ברירת מחדל 'הכל' + כולל היום
