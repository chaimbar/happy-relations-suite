...
- 2026-06-28 — תיקון: דיאלוג עריכת לקוח טוען עכשיו את נתוני הלקוח הקיים (remount דרך key) במקום טופס ריק.

- 2026-06-28 — תיקון סופי: עריכת לקוח מסנכרנת שדות דרך useEffect (כמו EmployeeDialog) במקום key. נדחף (88382a5).

- 2026-06-28 — אותו באג בעריכת אתר (ProjectDialog) ושלב (StageDialog): נוסף useEffect שמסנכרן form לפי editing. נדחף (8e5145d).

- 2026-06-28 — לקוחות: שדה "טלפון 2 / וואטסאפ" (phone2). מיגרציה + טופס + כרטיס (קישור wa.me) + חיפוש + CSV.

- 2026-07-12 · תוספות לאתר (טבלה + פאנל), שיבוץ כולם, גרירת עובד↔אתר, טאב היסטוריית שיבוצים
- 2026-07-12: שופר מסך שיבוצים — ברירת מחדל יומי, כפתורי שיבוץ ברורים לעובדים ללא שיבוץ ולימים ריקים.
- היסטוריית שיבוצים: ברירת מחדל 'הכל', כולל היום
