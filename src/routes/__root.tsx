...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ניהול אתרים — מערכת תפעולית" },
      { name: "description", content: "מערכת לניהול עובדים, אתרים, לקוחות ורווחיות בזמן אמת." },
      { property: "og:title", content: "ניהול אתרים — מערכת תפעולית" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Heebo:wght@300;400;500;600;700;800;900&family=Rubik:wght@300;400;500;600;700;800&display=swap" },
    ],
  }),
